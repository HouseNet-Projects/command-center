...
INTEGRATIONS = {
 ...
 "INT-TG": {
  ...
  "read_ops": {"identity": {"kind": "chat_identity", "params": []}, "chat.messages": {"kind": "chat_message", "params": ["limit", "timeout"]}, "business.connection": {"kind": "chat_connection", "params": ["refresh"]}}, "write_ops": [], "required_certification_ops": ["identity", "chat.messages"],
